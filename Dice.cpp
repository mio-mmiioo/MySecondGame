...
HRESULT  Dice::Initialize()
{
	...
	{
		// 1の目 0-3
		{ XMVectorSet(-1.0f,  1.0f, 1.0f, 1.0f), XMFLOAT2(0.0f,			0.0f)}, // 左上 (画像の左上)
		{ XMVectorSet(1.0f,  1.0f, 1.0f, 1.0f),	 XMFLOAT2(1.0f / 4.0f,	0.0f)}, // 右上 (画像の1/4の幅)
		{ XMVectorSet(1.0f, -1.0f, 1.0f, 1.0f),	 XMFLOAT2(1.0f / 4.0f,	0.5f)}, // 右下 (画像の1/4の幅, 半分の高さ)
